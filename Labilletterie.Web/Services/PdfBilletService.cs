        ...
        public byte[] GenererPdfBillet(Billet billet)
        {
            ...
            var document = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Margin(30);
                    page.PageColor(Color.FromHex("#000000"));
                    ...
                    page.Content().Column(col =>
                    {
                        ...
                        col.Item().Row(row =>
                        {
                            row.RelativeItem().Column(c =>
                            {
                                ...
                                c.Item().PaddingTop(10)
                                    .Text($"📅 {billet.Evenement?.DateEvenement.ToString("dd MMMM yyyy à HH:mm")}")
                                    .FontSize(10)
                                    .FontColor(Color.FromHex("#aaaaaa"));

                                c.Item().PaddingTop(5)
                                    .Text($"📍 {billet.Evenement?.Lieu ?? ""}")
                                    .FontSize(10)
                                    .FontColor(Color.FromHex("#aaaaaa"));

                                c.Item().PaddingTop(15)
                                    .Text($"👤 {billet.Acheteur?.Prenom} {billet.Acheteur?.Nom}")
                                    .FontSize(11).Bold();

                                c.Item().PaddingTop(5)
                                    .Text($"Réf : {billet.CodeQR[..8].ToUpper()}")
                                    .FontSize(9)
                                    .FontColor(Color.FromHex("#aaaaaa"));
                            });
                            ...
                            row.ConstantItem(110).Column(c =>
                            {
                                ...
                                // ✅ Nouvelle syntaxe QuestPDF sans méthode obsolète
                                c.Item().AlignCenter()
                                        .Image(qrBytes)
                                        .FitWidth();
                                c.Item().AlignCenter()
                                    .Text("Scanner à l'entrée")
                                    .FontSize(7)
                                    .FontColor(Color.FromHex("#aaaaaa"));
                            });
                        });
                        ...
                        {
                            row.RelativeItem()
                                .Text($"Prix payé : {billet.PrixPaye:0.00} €")
                                .FontSize(10)
                                .FontColor(Color.FromHex("#aaaaaa"));

                            row.RelativeItem().AlignRight()
                                .Text($"Acheté le {billet.DateAchat:dd/MM/yyyy}")
                                .FontSize(10)
                                .FontColor(Color.FromHex("#aaaaaa"));
                        });
                    });
            ...
            // ✅ Nouvelle syntaxe : GeneratePdf() sur le document
